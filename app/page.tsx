    ...
    <div className="min-h-screen bg-[#0a0e13]">
      ...
      <header className="relative border-b border-terminal-border overflow-hidden min-h-[520px] flex flex-col">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 text-center flex-1 flex flex-col items-center justify-center">
          ...
          >
            FWAuto — the command-line tool that brings AI into every step of
          ...
          >
            Follow along step by step. Check off each section as you complete
            it.
          </p>
          ...
          >
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-terminal-border bg-[#0d1117]/80 backdrop-blur text-xs text-terminal-comment"
              >
          ...
          >
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-terminal-green text-black text-sm font-bold hover:bg-terminal-green/90 transition-all hover:shadow-lg hover:shadow-terminal-green/20 active:scale-95"
            >
          ...
          <ScrollReveal>
            <div className="text-center mb-10">
              ...
              <p className="text-terminal-comment text-sm mt-2">
                ...
                on any terminal to watch it play out in real time.
              </p>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal delay={50}>
              <section id="prerequisites">
                ...
                >
                      ...
                      {[
                        {
                          tool: 'FWAuto Account',
                          version: 'Registered',
                          purpose: 'Create a free account at FWAuto Dashboard',
                        },
                        {
                          tool: 'uv',
                          version: 'latest',
                  ...
                  <Callout
                    type="info"
                    title="What happens if a tool is missing?"
                  >
                    The installer script checks for both{' '}
                    <code className="text-blue-300">uv</code> and{' '}
                    <code className="text-blue-300">Node.js</code> before
                    proceeding. If either is missing, it prints a clear error
                    message with the exact install command to run. No guessing
                    required.
                  </Callout>
                  <Callout
                    type="warning"
                    title="Windows users: Node.js requires special handling"
                  >
                    On Windows, Node.js must be installed via the{' '}
                    <strong>.msi installer</strong> from nodejs.org. After
                    installation, close and reopen PowerShell as Administrator.
                    See{' '}
                    <a
                      href="#windows-prereqs"
            ...
            <ScrollReveal delay={50}>
              <section id="install">
                <StepCard
                  ...
                  description="A single command handles the entire installation. Use the OS tabs below to select your platform, then press Run Demo to watch it happen."
                  badge="One Command"
                  badgeColor="green"
                ...
                >
                    ...
                    content={{
                      linux: (
                        <div className="space-y-3">
                          ...
                          >
                            <code>curl -LsSf</code> downloads the install script
                            silently and follows redirects. Piping to{' '}
                            <code>bash</code> runs it immediately. The script
                            installs both <code>fwauto</code> and the AI CLI
                            tools.
                          </Callout>
                        </div>
                      ),
                      macos: (
                        <div className="space-y-3">
                          ...
                          />
                          <Callout type="info">
                            macOS and Linux use the same script. If macOS shows
                            a security prompt, you can safely proceed.
                          </Callout>
                        </div>
                      ),
                      windows: (
                        <div className="space-y-4">
                          ...
                          >
                            ...
                            Right-click the Start menu → "Windows PowerShell
                            (Admin)".
                          </Callout>
                        </div>
                      ),
                  ...
                  />
                  <div className="mt-2">
                    <p className="text-sm font-medium text-terminal-text mb-3">
                      ▶ Watch the full install process:
                    </p>
                    <TerminalDemo
            ...
            <ScrollReveal delay={50}>
              <section id="verify">
                <StepCard
                  ...
                  description="Confirm FWAuto was installed correctly. You should see the ASCII banner and a list of commands."
                ...
                >
                  ...
                  <Callout type="success" title="Installation confirmed!">
                    If you see output similar to above, FWAuto is installed and
                    ready. The version number appears just below the ASCII
                    banner.
                  </Callout>
                </StepCard>
              </section>
            ...
            <ScrollReveal delay={50}>
              <section id="auth">
                <StepCard
                  ...
                  description="FWAuto uses Google OAuth. Run the demo to watch the full authentication flow in a simulated terminal."
                  badge="Google OAuth"
                  badgeColor="blue"
                ...
                >
                    ...
                    {[
                      {
                        ...
                        desc: 'Select the Google account you registered with on the FWAuto Dashboard.',
                      },
                      {
                        num: '2',
                        title: 'Grant access',
                        desc: 'FWAuto requests your name, photo, and email. Click "Continue" to approve.',
                      },
                      {
                        num: '3',
                        title: 'Login successful',
                        desc: 'Your browser shows "Login Successful!". Close it and return to your terminal.',
                      },
                    ].map((s) => (
                      <div
                        key={s.num}
                  ...
                  <p className="text-sm font-medium text-terminal-text mt-2">
            ...
            <ScrollReveal delay={50}>
              <section id="init">
                <StepCard
                  ...
                  description="Navigate to your firmware project and run any FWAuto command. If not yet initialized, the 3-step Setup Wizard launches automatically."
                ...
                >
                  <Callout type="info" title="Navigate to your project first">
                    Make sure you're inside your firmware project folder before
                    running this command.
                  </Callout>
                  <CodeBlock
                    code={`cd /path/to/your/firmware-project\nfwauto build`}
                    title="Trigger Setup Wizard"
                  />
                  <div className="space-y-3">
                    {[
                      {
                        step: '[1/3] SDK Configuration',
                        desc: 'Enter the path to your firmware SDK. Press Enter to accept the default in brackets.',
                        example:
                          'SDK path [/opt/ti-sdk]: /home/user/ATK-AM62x-SDK',
                      },
                      {
                        step: '[2/3] Build Configuration',
                        desc: "Select '1' for Makefile (most common) or '2' for a custom shell command.",
                        example:
                          'Build type:\n  1. makefile\n  2. command\nSelect [1]: 1',
                      },
                      {
                        step: '[3/3] Deploy Configuration',
                        desc: "'network' uses SSH, 'serial' uses a serial port, 'command' runs a custom script.",
                        example:
                          'Deploy type:\n  1. network\n  2. serial\n  3. command\nSelect [1]: 1',
                      },
                    ].map((item, i) => (
                  ...
                  <Callout
                    type="warning"
                    title="You must customize the Makefile"
                  >
                    The generated Makefile is a template. Edit it for your
                    project's source paths, compiler, and output directories
                    before building.
                  </Callout>
                </StepCard>
              </section>
            ...
            <ScrollReveal delay={50}>
              <section id="build">
                <StepCard
                  ...
                  description="Compile your firmware with one command. Watch the demo below to see AI auto-repair kick in when a build error occurs."
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div className="p-4 rounded-xl border border-green-800 bg-green-950/20">
                      ...
                      <p className="text-sm text-terminal-comment">
                        Output files are placed in the directory configured in
                        your Makefile.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border border-yellow-800 bg-yellow-950/20">
                      ...
                      <p className="text-sm text-terminal-comment">
                        FWAuto captures the error, asks the AI for a fix,
                        applies it, and retries — up to 3 times.
                      </p>
                    </div>
                  </div>
                  <div className="mt-2">
                    <p className="text-sm font-medium text-terminal-text mb-3">
                      ▶ Watch AI auto-repair a build error:
                    </p>
                    <TerminalDemo
                  ...
                  <Callout
                    type="info"
                    title="AI auto-repair only fixes compilation errors"
                  >
                    Configuration errors (like a missing Makefile) do not
                    trigger AI repair. Always read the error message first.
                  </Callout>
                </StepCard>
              </section>
            </ScrollReveal>
            ...
            <ScrollReveal delay={50}>
              <section id="deploy">
                <StepCard
                  ...
                  description="Flash compiled firmware to your hardware. Supports network (SSH), serial port, and custom command deployment."
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm text-terminal-comment mb-2">
                        Basic deploy (uses your configured method):
                      </p>
                      <CodeBlock code={`fwauto deploy`} />
                    </div>
                    <div>
                      <p className="text-sm text-terminal-comment mb-2">
                        Deploy with startup arguments passed to the binary:
                      </p>
                      <CodeBlock code={`fwauto deploy --binary-args "on"`} />
                      <p className="text-xs text-terminal-comment mt-2">
                        <code className="text-blue-400">--binary-args</code>{' '}
                        passes arguments to the firmware when it starts. Useful
                        for modes like{' '}
                        <code className="text-terminal-green">"debug"</code> or{' '}
                        <code className="text-terminal-green">"test"</code>.
                      </p>
                    </div>
                  </div>
                  <Callout
                    type="tip"
                    title="Network deployment (AM62X / Linux boards)"
                  >
                    Configure <code className="text-purple-300">board_ip</code>,{' '}
                    <code className="text-purple-300">board_user</code>, and{' '}
                    <code className="text-purple-300">deploy_path</code> in your{' '}
                    <code className="text-purple-300">config.toml</code>. FWAuto
                    uses SSH to copy and run the binary.
                  </Callout>
                </StepCard>
              </section>
            </ScrollReveal>
            ...
            <ScrollReveal delay={50}>
              <section id="logs">
                <StepCard
                  ...
                  description="Ask the AI natural-language questions about your firmware's runtime behavior. Just point it at a log file and ask anything."
                  badge="AI Analysis"
                  badgeColor="blue"
                ...
                >
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm text-terminal-comment mb-2">
                        Analyze the most recent auto-detected log:
                      </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-2">
                    {[
                      ...
                      <div
                        key={i}
                        className="px-3 py-2 rounded-lg border border-terminal-border bg-[#161b22] text-sm font-mono text-terminal-green hover:border-terminal-green/40 transition-colors cursor-default"
                      >
                        {q}
                      </div>
                    ))}
            ...
            <ScrollReveal delay={50}>
              <section id="chat">
                <StepCard
                  ...
                  description="Launch FWAuto's conversational interface. Control your entire firmware workflow with natural language or slash commands."
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div className="p-4 rounded-xl border border-terminal-border bg-[#161b22]">
                      <p className="text-xs font-semibold text-terminal-green uppercase tracking-wider mb-2">
                        Explicit — Slash Commands
                      </p>
                      <p className="text-sm text-terminal-comment mb-3">
                  ...
                  <Callout
                    type="tip"
                    title="Switch to Traditional Chinese responses"
                  >
                    Enter this in chat mode:{' '}
            ...
            <ScrollReveal delay={50}>
              <section id="faq">
                <StepCard
                  ...
                  description="Solutions to the most frequently encountered problems. Click any question to expand."
            ...
            <ScrollReveal delay={50}>
              ...
              >
                ...
                <p className="text-terminal-comment text-sm leading-relaxed">
                  Windows requires extra steps. Node.js must be installed via
                  the official .msi installer, and PowerShell needs specific
                  configuration.
                </p>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-terminal-comment mt-2">
                      ...
                      to let PATH changes take effect.
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-terminal-text mb-2">
                    ...
                    <p className="text-sm text-terminal-comment mb-2">
                      ...
                      and download the Windows Installer (.msi), version 20+.
                    </p>
                    <Callout type="warning">
                      Ensure <strong>"Add to PATH"</strong> is checked. After
                      install, close and reopen PowerShell.
                    </Callout>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-terminal-text mb-2">
                  ...
                  commands={[
                    {
                      cmd: 'build (target)',
                      description:
                        "Must exist. FWAuto calls 'make build' by default. Configurable in config.toml.",
                    },
                    {
                      cmd: 'Return code 0',
                      description:
                        'Return 0 for success, non-zero for failure (may trigger AI repair).',
                    },
                    {
                      cmd: 'stdout/stderr',
                      description:
                        'All output is captured and sent to the AI for error analysis.',
                    },
                  ]}
                />
                <CommandTable
                  title="Key Variables (AM62X example)"
                  commands={[
                    {
                      cmd: 'ARAGO_ENV',
                      description: 'SDK environment setup script path',
                    },
                    {
                      cmd: 'SYSROOT',
                      description: 'Cross-compilation sysroot path',
                    },
                    {
                      cmd: 'CC',
                      description: 'Cross-compiler binary',
              ...
              <div className="rounded-2xl border border-terminal-green/30 bg-terminal-green/5 p-8 text-center relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-terminal-comment text-sm max-w-md mx-auto mb-6">
                    You&apos;ve covered everything from installation to AI log
                    analysis. Head to the FWAuto Dashboard to manage your
                    projects.
                  </p>
                  <a
                    href="https://fwauto.ai"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-terminal-green text-black text-sm font-bold hover:bg-terminal-green/90 transition-all hover:shadow-lg hover:shadow-terminal-green/20 active:scale-95"
                  >
      ...
      <footer className="border-t border-terminal-border mt-20 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-terminal-comment font-mono">
            FWAuto Quickstart Guide — by Eka Gunawan
          </p>
          <p className="text-xs text-terminal-comment font-mono">
            <a
              href="https://fwauto.ai"
